...
class TestMCPAnalyticsAPI(APIBaseTest):
    def test_create_feedback_submission(self):
    ...
    def test_create_missing_capability_submission_defaults_blocked(self):
        response = self.client.post(
    ...
    def test_feedback_list_is_team_scoped(self):
    ...
    def test_feedback_and_missing_capability_lists_are_split_by_kind(self):
        MCPAnalyticsSubmission.objects.create(
            team=self.team,
            created_by=self.user,
            kind=MCPAnalyticsSubmission.Kind.FEEDBACK,
