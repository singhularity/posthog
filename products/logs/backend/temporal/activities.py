...
def _evaluate_single_alert(
    ...
    with transaction.atomic():
        LogsAlertCheck.objects.create(
            ...
            error_message=outcome.error_message or check_result.error_message,
    ...
    # Emit internal event for notifications (outside transaction).
    # Only update last_notified_at after Kafka confirms — if Kafka fails,
    # the next tick will retry because last_notified_at stays stale.
    notified = False
