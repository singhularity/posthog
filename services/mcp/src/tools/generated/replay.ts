...
const sessionRecordingsList = (): ToolBase<
    ...
    Schemas.PaginatedSessionRecordingList & { _posthogUrl: string }
> => ({
    ...
    handler: async (context: Context, params: z.infer<typeof SessionRecordingsListSchema>) => {
        ...
        return {
            ...(result as any),
            _posthogUrl: `${context.api.getProjectBaseUrl(projectId)}/replay`,
        }
    },
})
...
const sessionRecordingPlaylistsList = (): ToolBase<
    ...
    Schemas.PaginatedSessionRecordingPlaylistList & { _posthogUrl: string }
> => ({
