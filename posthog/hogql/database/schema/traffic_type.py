...
def _user_agent_expr(properties_path: Optional[list[str]] = None) -> ast.Expr:
...
def create_is_bot_field(name: str, properties_path: Optional[list[str]] = None) -> ExpressionField:
    return ExpressionField(
        name=name,
        expr=is_bot(node=_dummy_call(), args=[_user_agent_expr(properties_path)]),
        isolate_scope=True,
    )
...
def create_traffic_type_field(name: str, properties_path: Optional[list[str]] = None) -> ExpressionField:
    return ExpressionField(
        name=name,
        expr=get_traffic_type(node=_dummy_call(), args=[_user_agent_expr(properties_path)]),
        isolate_scope=True,
    )
...
def create_traffic_category_field(name: str, properties_path: Optional[list[str]] = None) -> ExpressionField:
    return ExpressionField(
        name=name,
        expr=get_traffic_category(node=_dummy_call(), args=[_user_agent_expr(properties_path)]),
        isolate_scope=True,
    )
...
def create_bot_name_field(name: str, properties_path: Optional[list[str]] = None) -> ExpressionField:
    return ExpressionField(
        name=name,
        expr=get_bot_name(node=_dummy_call(), args=[_user_agent_expr(properties_path)]),
        isolate_scope=True,
    )
